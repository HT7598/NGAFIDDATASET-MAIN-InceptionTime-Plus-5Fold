...
```bash
python train_before_after_cv.py --model-name inception --only-fold 0 --epochs 10 --steps-per-epoch 100
```

Outputs will be written to:

- `outputs/inception/before_after_cv/fold_0/history.csv`
- `outputs/inception/before_after_cv/fold_0/predictions.csv`
- `outputs/inception/before_after_cv/fold_0/metrics.json`
- `outputs/inception/before_after_cv/fold_0/best_before_after.weights.h5`

## Run 5-fold cross validation

```bash
python train_before_after_cv.py --model-name inception --epochs 10 --steps-per-epoch 100
```

Cross-validation outputs:

- `outputs/inception/before_after_cv/cv_results.csv`
- `outputs/inception/before_after_cv/summary.json`
- `outputs/inception/before_after_cv/fold_*/...`
